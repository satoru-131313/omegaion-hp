      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 w-full">
        <motion.div style={{ y: y1 }} className="flex flex-col items-center text-center space-y-6 sm:space-y-8 relative z-20 max-w-5xl mx-auto">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.15] tracking-tight text-white"
          >
            {t.hero.title}<br/>
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg lg:text-xl text-slate-400 max-w-3xl leading-relaxed"
          >
             {t.hero.desc}
          </motion.p>
          ...
          >
             <a href="https://app.omegaion.com/login" className="group px-10 py-4 bg-white text-slate-950 font-bold rounded-full hover:bg-cyan-50 transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(34,211,238,0.4)] text-base md:text-lg">
               {t.hero.cta}
               <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
             </a>
             <button className="px-10 py-4 bg-slate-800/50 text-white font-medium rounded-full hover:bg-slate-700/50 transition-all border border-slate-700 flex items-center justify-center gap-2 backdrop-blur-sm text-base md:text-lg">
        ...
        <motion.div
          ...
          className="relative z-20 mt-16 w-full max-w-6xl mx-auto"
        >
          <img 
            src="/ui-mockup.png" 
            alt="OmegaIon Dashboard UI" 
            className="w-full h-auto object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.8)] drop-shadow-[0_0_60px_rgba(34,211,238,0.2)]"
          />
        </motion.div>
      </div>
