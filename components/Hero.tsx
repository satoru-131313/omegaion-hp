  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 perspective-2000">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center justify-center text-center">
        <motion.div style={{ y: y1 }} className="max-w-5xl space-y-10 relative z-20 flex flex-col items-center">
          <motion.div 
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-950/40 backdrop-blur-md text-cyan-300 text-xs font-bold tracking-widest uppercase shadow-[0_0_20px_rgba(34,211,238,0.2)]"
          >
              ...
              {!showLogo ? (
                ...
                >
                  <img 
                    src="/logo.png" 
                    alt="OmegaIon Logo" 
                    className="w-full max-w-[600px] h-auto object-contain drop-shadow-[0_0_50px_rgba(34,211,238,0.2)]" 
                  />
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-8">
             <a href="https://app.omegaion.com/login" className="group px-10 py-5 bg-white text-slate-950 font-bold rounded-full hover:bg-cyan-50 transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(34,211,238,0.4)] text-lg">
               {t.hero.cta}
